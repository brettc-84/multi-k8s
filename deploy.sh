...
docker push brettc84/multi-client:latest
docker push brettc84/multi-server:latest
docker push brettc84/multi-worker:latest
docker push brettc84/multi-client:$GIT_SHA
docker push brettc84/multi-server:$GIT_SHA
docker push brettc84/multi-worker:$GIT_SHA
kubectl apply -f k8s
